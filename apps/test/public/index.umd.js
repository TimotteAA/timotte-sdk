(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TIMOTTE_CORE = {}));
	...
	(function (BrowserBreadcrumbTypes) {
	    ...
	    BrowserBreadcrumbTypes["CODE_ERROR"] = "code_error";
	...
	class PageCrashWorker {
	    ...
	    checkCrash() {
	        for (const appId of Object.keys(this.apps)) {
	            ...
	            const { message: { sendUrl, clientInfo }, } = info;
